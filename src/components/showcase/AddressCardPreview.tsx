      ...
      >
        <div className="flex justify-between items-start">
          ...
          >
            <AnimatePresence>
              {bellRing && (
                <>
                  <motion.div
                    className="absolute inset-[-8px] rounded-full border-2 border-white/40"
            ...
            <motion.div
              animate={
                bellRing
                  ? { rotate: [0, 18, -18, 14, -14, 8, -8, 0], scale: [1, 1.2, 1.2, 1.15, 1.15, 1.05, 1.05, 1] }
                  : { rotate: 0, scale: 1 }
              }
          ...
          <div className="flex gap-2.5 opacity-80">
            <a href="https://github.com/Quantapar" target="_blank" rel="noopener noreferrer" className="hover:opacity-60 transition-opacity">
            ...
            <a href="https://x.com/quantapar" target="_blank" rel="noopener noreferrer" className="hover:opacity-60 transition-opacity">
            ...
            <a href="https://www.instagram.com/iknewtyler/" target="_blank" rel="noopener noreferrer" className="hover:opacity-60 transition-opacity">
